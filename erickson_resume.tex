...
\begin{document}
  ...
  \begin{description}
		\item[Skills] Django, Python, Java, MySQL, database design, HTML, CSS,
      \LaTeX, git (all in OS X or Linux)
		\item[Dabblings] JavaScript, jQuery, C, R, ML, PHP
    \item[M.S. in Computer Science] New York University, current
    (expected graduation 2015), 4.0 GPA
    ...
    \item[GRE] 2011, Quantitative 800/800, Verbal 780/800,
  ...
  \end{description}
	...
	\begin{description}
		...
		\emph{Labs of Drs. Fabio Piano and Kris Gunsalus,
	...
	\begin{description}
      ...
      Built WordPress site for a birder's conservation project.
      Documented roadkill on cross-country trip to encourage
      responsible driving.
