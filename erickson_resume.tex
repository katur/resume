...
\begin{document}
  ...
  \begin{description}
    \item[Skills] Django, Python, Java, SQL, database design, HTML, CSS, \LaTeX,
    git (all in OS X or Linux)

    \item[Dabblings] JavaScript, jQuery, C, R, ML, PHP

    \item[M.S. in Computer Science] New York University, current (expected
    graduation 2015), 4.0 GPA
    ...
    \setitemize[0]{leftmargin=0pt,itemindent=10pt}
    \begin{itemize}
      \item Highest Honors in Biology, Phi Beta Kappa Honor Society, and Sigma
  ...
  \begin{description}
      ...
      coast-to-coast across the Southern United States,
      along the Mississippi River,
      circumnavigating Lake Superior,
      and from Portland to San Francisco.

      \item[Steel Drums]
      Competed with 100-member NY Pan Sonatas in five NYC Panorama competitions
      (3 wins). Played and toured with Oberlin's student-run steel drum band,
      and taught a course for college and high school students.

      \item[Wildlife Conservation]
      Built WordPress site for a birder's conservation project. Documented
      roadkill on cross-country trip to encourage responsible driving.
      Helped rehab birds and small mammals throughout childhood.
